  ...
  return (
    <section className="menu">
      ...
      <section className="center-container">
        <nav>
          <div>
            <Link className="menu-element" to="/raporty">
              Raporty
            </Link>
          ...
          <div>
            <Link className="menu-element" to="/rezerwacje">
              Rezerwacje
            </Link>
            <Link to="/formularz-rezerwacji">
              <GraySquareWithPlus />
            </Link>
          </div>
          <div>
          ...
          <div>
            <Link className="menu-element" to="/dodaj-specjalizacje">
              Dodaj specjalizację
            </Link>
          </div>
        </nav>
