...
describe('ReportDetails', () => {
  ...
  it('fetches and displays report details', async () => {
    ...
    expect(await screen.findByText('Typ raportu: Report 1')).toBeInTheDocument();
    ...
    expect(screen.getByText('Opis: Lorem ipsum dolor sit amet')).toBeInTheDocument();
    expect(screen.getByText('Suma: 1000')).toBeInTheDocument();
    expect(screen.getByText('Wygenerowano przez: John Doe')).toBeInTheDocument();
  });
