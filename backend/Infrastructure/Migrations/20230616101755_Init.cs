        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainSpecializationId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Employees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Employees_Specializations_MainSpecializationId",
                        column: x => x.MainSpecializationId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assigments", x => new { x.EmployeeId, x.ServiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_MainSpecializationId",
                table: "Employees",
                column: "MainSpecializationId");
